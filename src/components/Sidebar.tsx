      ...
      <div className="mt-auto px-2">
        ...
        >
          ...
          <div className="overflow-hidden text-left">
            <p className="text-[11px] font-outfit font-bold text-white truncate uppercase tracking-tighter group-hover:text-primary-container transition-colors">{user.name}</p>
            <p className="text-[9px] text-primary-container font-space font-bold uppercase tracking-widest">{user.role}</p>
          </div>
